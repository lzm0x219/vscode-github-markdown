...
**说明：** 确认当前插件顺序为 `taskLists -> alerts -> emoji -> footnotes -> theme -> imageUrl`，并让验证或文档能及时暴露顺序误改。
...
**说明：** 中英文 README 已补充完整的特性说明（GitHub 风格 Markdown、主题系统、Mermaid 图表），其中包含主题命令能力。
...
**说明：** `test/fixtures/github-flavored-markdown-checklist.md` 已整合为一份自包含的综合验证文档，覆盖基础排版、链接、代码、列表、表格、引用/Alerts、图片、折叠区块、Emoji、脚注、Mermaid 图表（18 种类型）、GeoJSON/TopoJSON/STL、HTML 元素等全部 12 个类别。
